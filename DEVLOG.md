...
- Verification: ran `python3 -m unittest test_policies.py`; ran `python3 -m unittest test_policies.py test_compare_models.py test_collect_policy_data.py`; ran `python3 -m unittest test_model_report.py`; ran `python3 -m unittest test_play_with_model.py test_game_core.py`; ran `python3 -m unittest test_train_pipeline.py test_policies.py test_compare_models.py test_model_report.py`; ran `python3 -m unittest test_train_pipeline.py test_policies.py test_compare_models.py test_model_report.py test_play_with_model.py test_game_core.py test_collect_policy_data.py`; ran `python3 -m unittest`; ran `python3 -X pycache_prefix=/private/tmp/rockfall-pycache -m py_compile collect_policy_data.py compare_models.py data_quality.py data_store.py difficulty.py evaluate_model.py features.py game.py game_audio.py game_core.py game_events.py inspect_data.py model_report.py play_with_model.py policies.py release_check.py run_model_experiment.py scores.py settings.py spawning.py train_model.py train_pipeline.py test_collect_policy_data.py test_compare_models.py test_data_quality.py test_data_store.py test_difficulty.py test_evaluate_model.py test_features.py test_game.py test_game_audio.py test_game_core.py test_inspect_data.py test_model_report.py test_play_with_model.py test_policies.py test_release_check.py test_run_model_experiment.py test_scores.py test_spawning.py test_train_model.py test_train_pipeline.py`; ran `python3 collect_policy_data.py --data /private/tmp/rockfall-pipeline-ore-hunter-data.json --policy ore-hunter --games 3 --max-frames 360 --difficulty normal --player-speed 8 --lives 3 --variant-profile variant-rich --report /private/tmp/rockfall-pipeline-ore-hunter-data-report.json`; ran `python3 train_pipeline.py --data /private/tmp/rockfall-pipeline-ore-hunter-data.json --candidate /private/tmp/rockfall-pipeline-candidate.pkl --report /private/tmp/rockfall-pipeline-report.json --estimators 5 --games 1 --max-frames 240 --difficulty normal --player-speed 8 --lives 3 --variant-profile variant-rich --min-score-delta 0`; ran `python3 compare_models.py game_model.pkl --include-rule-baseline --include-ore-hunter-baseline --games 1 --max-frames 240 --difficulty normal --player-speed 8 --lives 3 --variant-profile variant-rich --report /private/tmp/rockfall-ore-hunter-comparison.json`; ran `python3 model_report.py --games 1 --max-frames 240 --difficulty normal --player-speed 8 --lives 3 --report /private/tmp/rockfall-policy-baseline-model-report.json`; ran `python3 release_check.py --games 1 --max-frames 240 --difficulty normal --player-speed 8 --lives 3 --report /private/tmp/rockfall-pipeline-release-check.json`; ran `python3 -m json.tool /private/tmp/rockfall-pipeline-report.json`; ran `python3 -m json.tool /private/tmp/rockfall-ore-hunter-comparison.json`; ran `python3 -m json.tool /private/tmp/rockfall-policy-baseline-model-report.json`; ran `python3 -m json.tool /private/tmp/rockfall-pipeline-release-check.json`; ran a stale-text scan for old version/risk-bonus terms; ran `git diff --check`.
