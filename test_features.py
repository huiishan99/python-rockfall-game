...
class ModelFeatureTest(unittest.TestCase):
    ...
    def test_no_obstacle_uses_neutral_position(self):
        ...
        self.assertEqual(features, [200, 200, 0, 0, 0, 0])
